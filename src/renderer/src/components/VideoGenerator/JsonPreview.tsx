	...
	if (!recording) {
		return (
			<div className="flex h-full flex-col gap-2">
				...
				<div className="flex h-full items-center justify-center rounded border border-white/10 bg-gray-800 text-white/50">
	...
	return (
		<div className="flex h-full flex-col gap-2">
			...
			<textarea
				readOnly
				value={jsonContent}
				className="flex h-full resize-none rounded border border-white/10 bg-gray-800 p-3 font-mono text-xs text-white/90 focus:ring-1 focus:ring-blue-500 focus:outline-none"
				spellCheck={false}
			/>
		</div>
	);
