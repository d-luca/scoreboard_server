	...
	return (
		<div className="flex h-full gap-3 bg-indigo-950 text-nowrap">
			<div className="flex items-center justify-between gap-2" style={{ transform: "skewX(15deg)" }}>
				...
				<div className="flex w-28 items-center justify-center tracking-wider text-white" data-home-name>
					{teamHomeName}
				</div>
			</div>{" "}
			...
			<div className="flex items-center justify-between gap-2" style={{ transform: "skewX(15deg)" }}>
				<div className="flex w-28 items-center justify-center tracking-wider text-white" data-away-name>
					{teamAwayName}
				</div>
